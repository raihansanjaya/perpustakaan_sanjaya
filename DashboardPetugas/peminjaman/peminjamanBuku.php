...
<html lang="en">
  ...
  <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        ...
        <a class="bg btn-tertiary" href="../dashboardAdmin.php">Dashboard</a>
      </div>
    </nav>
      ...
      <div class="table-responsive mt-3">
        ...
        <thead class="text-center">
          ...
          <tr>
            ...
            <th class="bg-warning text-light">Nisn Siswa</th>
            <th class="bg-warning text-light">Nama siswa</th>
            <th class="bg-warning text-light">Kelas</th>
            <th class="bg-warning text-light">Jurusan</th>
            <th class="bg-warning text-light">Id Admin</th>
            <th class="bg-warning text-light">Tanggal Peminjaman</th>
            <th class="bg-warning text-light">Tanggal Pengembalian</th>
